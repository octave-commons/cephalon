...
This repo is the consolidation point for the **head** of the agent system.
...
Absorbed historical docs now live under `docs/history/`, including:
- Duck context protocol
- MCP subcommands
- cephalon-clj recovery and merge notes
- Discord IO bridge consolidation plan
- cephalon-ts merge history

## Truth note

Not every branch here is equally mature, but from this point on they belong to one canon instead of being strewn across unrelated root directories.
